...
type Config struct {
	...
	// BootDisk is deprecated: use Boot's "order=" instead.
	...
	// property string.
	SMBios1 string `json:"smbios1,omitempty" url:"smbios1,omitempty"`
	...
	// Autostart enables an automatic restart after a crash (currently
	// ignored by Proxmox).
	...
	// CPU is the emulated CPU type as a property string, e.g.
	// "cputype=host".
	CPU string `json:"cpu,omitempty" url:"cpu,omitempty"`
	...
	// AMDSev configures AMD SEV confidential-computing features as a
	// property string.
	AMDSev string `json:"amd-sev,omitempty" url:"amd-sev,omitempty"`
	// IntelTDX configures Intel TDX confidential-computing features as
	// a property string.
	IntelTDX string `json:"intel-tdx,omitempty" url:"intel-tdx,omitempty"`
	// Memory is the guest's memory configuration as a property string,
	// e.g. "2048" or "current=2048,max=8192".
	Memory string `json:"memory,omitempty" url:"memory,omitempty"`
